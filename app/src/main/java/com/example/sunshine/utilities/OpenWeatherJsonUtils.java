...
public final class OpenWeatherJsonUtils {
     ...
     *
     */
//    public static ArrayList<String> getSimpleWeatherStringsFromJson(Context context, JSONArray jsonArray) throws JSONException{
//
//
//        /* String array to hold each day's weather String */
//        ArrayList<String> parsedWeatherData = new ArrayList<>();
//
...
//    }
     ...
     */
    public static ContentValues[] getWeatherContentValuesFromJson(Context context, JSONArray jsonArray)
...
//        SunshinePreferences.setLocationDetails(context, cityLatitude, cityLongitude);
        ...
        ContentValues[] weatherContentValues = new ContentValues[jsonArray.length()];
